...
function validarContraseña(){
	...
	if(pass != '' && pass2 != ''){
		if(pass != pass2){
			...
			document.getElementById('resultado5').innerHTML = '<p class="error"><strong>Error: </strong>¡Las contraseñas no coinciden!</p>';	
			...
			document.getElementById('resultado5').innerHTML = '<p class="correcto"><strong>✓ Correcto: </strong>Contraseña valida.</p>';
		}
	} else {
		//si los campos o uno, este vacio
